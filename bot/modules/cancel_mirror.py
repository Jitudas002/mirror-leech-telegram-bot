...
def cancel_mirror(update, context):
    ...
    if len(args) == 1 and (
        ...
        msg = f"Reply to active <code>/{BotCommands.LeechCommand}</code> message which was used to start the download or send <code>/{BotCommands.CancelMirror} GID</code> to cancel it!"
