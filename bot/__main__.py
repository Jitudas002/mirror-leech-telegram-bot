...
def start(update, context):
    ...
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
Hi 👋, I'm already start bro any help
Type /{BotCommands.HelpCommand} to get a list of available commands
'''
        sendMarkup(start_string, context.bot, update, reply_markup)
    else:
        sendMarkup('This Bot Only Works At <b>18+ Leech Group</b>', context.bot, update, reply_markup)
...
<br><br>
<b>/{BotCommands.LeechWatchCommand}</b> [yt-dlp supported link]: Leech supported link <code>xvideos.com, pornhub.com, xhamster3.com</code> or more yt-dlp supported sites... <code>(Note only free or Public videos can leeching)</code> 
<br><br>
<b>/{BotCommands.LeechZipWatchCommand}</b> [yt-dlp supported link]: Leech supported link <code>xvideos.com, pornhub.com, xhamster3.com</code> or more yt-dlp supported sites... <code>(Free and public videos only)</code> as zip
<br><br>
...
<br><br>
<b>/{BotCommands.SearchCommand}</b> [query]: Search for torrents
<br>sites: <code>rarbg, 1337x, yts, etzv, tgx, torlock, piratebay, nyaasi, ettv</code><br><br>
<b>/{BotCommands.StatusCommand}</b>: Shows a status of all the downloads
<br><br>
<b>/{BotCommands.StatsCommand}</b>: Show Stats of the machine the bot is hosted on
<br><br>
<b>/{BotCommands.SpeedCommand}</b>: Check Internet Speed of the Host by ookla
'''

help = telegraph.create_page(
        title='18+ Leech Group',
